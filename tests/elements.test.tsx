...
describe("elements", () => {
  it("can render an <a> element", () => {
    const html = <a href="google.com/hello.html" target="_blank" referrerpolicy="no-referrer">Try google</a>;
    expect(html).to.equal('<a href="google.com/hello.html" target="_blank" referrerpolicy="no-referrer">Try google</a>');
  });
